...
class FondoBase(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.fondo = pygame.image.load("juegotole/imagenes/2.png")  #imagen fondo base
...
class FondoMontañas(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.montañas = pygame.image.load("juegotole/imagenes/montañas.png")  #imagen fondo base
