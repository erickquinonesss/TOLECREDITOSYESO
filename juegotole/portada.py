...
class Portada(pygame.sprite.Sprite):
    def __init__(self, fondo_img):
        super().__init__()
        self.fondo_portada = pygame.image.load("juegotole/imagenes/portada.jpg")  # Carga la imagen de fondo
...
def toleportada(tiempo_portada):
    ...
    fondo_img = pygame.image.load("juegotole/imagenes/portada.jpg")
